...
from utils.kittiloader import calibread
...
# Frustum-PointNet:
with open(root_dir + "training_logs/model_Frustum-PointNet_eval_val/eval_dict_val.pkl", "rb") as file: # NOTE! you'll have to adapt this for your file structure
    eval_dict = pickle.load(file)
#################################
# # Extended-Frustum-PointNet:
# with open(root_dir + "training_logs/model_Extended-Frustum-PointNet_eval_val/eval_dict_val.pkl", "rb") as file: # NOTE! you'll have to adapt this for your file structure
#     eval_dict = pickle.load(file)
# ##################################
# # Image-Only:
# with open(root_dir + "training_logs/model_Image-Only_eval_val/eval_dict_val.pkl", "rb") as file: # NOTE! you'll have to adapt this for your file structure
#     eval_dict = pickle.load(file)
