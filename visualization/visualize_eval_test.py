...
# Frustum-PointNet:
with open(root_dir + "training_logs/model_Frustum-PointNet_eval_test/eval_dict_test.pkl", "rb") as file: # NOTE! you'll have to adapt this for your file structure
    eval_dict = pickle.load(file)
#################################
# # Extended-Frustum-PointNet:
# with open(root_dir + "training_logs/model_Extended-Frustum-PointNet_eval_test/eval_dict_test.pkl", "rb") as file: # NOTE! you'll have to adapt this for your file structure
#     eval_dict = pickle.load(file)
# ##################################
# # Image-Only:
# with open(root_dir + "training_logs/model_Image-Only_eval_test/eval_dict_test.pkl", "rb") as file: # NOTE! you'll have to adapt this for your file structure
#     eval_dict = pickle.load(file)
