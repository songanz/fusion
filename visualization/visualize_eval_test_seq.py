...
sys.path.append(root_dir)  # NOTE! you'll have to adapt this for your file structure
from utils.kittiloader import LabelLoader2D3D, calibread
...
for sequence in ["0001", "0002", "0007", "0011"]:
    ...
    # Frustum-PointNet:
    with open(root_dir + "training_logs/model_Frustum-PointNet_eval_test_seq/eval_dict_test_seq_%s.pkl" % sequence, "rb") as file: # NOTE! you'll have to adapt this for your file structure
        eval_dict = pickle.load(file)
    #################################
    # # Extended-Frustum-PointNet:
    # with open(root_dir + "training_logs/model_Extended-Frustum-PointNet_eval_test_seq/eval_dict_test_seq_%s.pkl" % sequence, "rb") as file: # NOTE! you'll have to adapt this for your file structure
    #     eval_dict = pickle.load(file)
    # #################################
    # # Image-Only:
    # with open(root_dir + "training_logs/model_Image-Only_eval_test_seq/eval_dict_test_seq_%s.pkl" % sequence, "rb") as file: # NOTE! you'll have to adapt this for your file structure
    #     eval_dict = pickle.load(file)
