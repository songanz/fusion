...
// evaluation parameter for different difficulty
...
// const double   MIN_OVERLAP[3][NUM_CLASS] = {{0.5, 0.5, 0.5, 0.7, 0.7, 0.5, 0.7},
//                                             {0.5, 0.5, 0.5, 0.7, 0.7, 0.5, 0.7},
//                                             {0.5, 0.5, 0.5, 0.7, 0.7, 0.5, 0.7}};
// the minimum overlap required for 2D evaluation on the image/ground plane and 3D evaluation
  ...
  for (int32_t i=0; i<N_TESTIMAGES; i++) {
    ...
    switch (append_zeros){
      ...
      case 8:
        ...
        break;
      case 10:
        sprintf(file_name,"%d.txt",indices[i]);
        break;
      default:
