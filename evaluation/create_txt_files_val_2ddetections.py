...
sys.path.append(root_dir + "utils")  # NOTE! you'll have to adapt this for your file structure
...
# Frustum-PointNet:
with open(root_dir + "training_logs/model_Frustum-PointNet_eval_val_2ddetections/eval_dict_val_2ddetections.pkl", "rb") as file: # NOTE! you'll have to adapt this for your file structure
    eval_dict = pickle.load(file)
#################################
# # Extended-Frustum-PointNet:
# with open(root_dir + "training_logs/model_Extended-Frustum-PointNet_eval_val_2ddetections_1/eval_dict_val_2ddetections.pkl", "rb") as file: # NOTE! you'll have to adapt this for your file structure
#     eval_dict = pickle.load(file)
# ##################################
# # Image-Only:
# with open(root_dir + "training_logs/model_Image-Only_eval_val_2ddetections/eval_dict_val_2ddetections.pkl", "rb") as file: # NOTE! you'll have to adapt this for your file structure
#     eval_dict = pickle.load(file)
