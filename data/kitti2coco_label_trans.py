...
# test example
kitti_img_path_train = root_dir + 'data/kitti/object/training/image_2/'

kitti_label_path_train = root_dir + 'data/kitti/object/training/label_2/'

kitti_img_path_test = root_dir + 'data/kitti/object/testing/image_2/'

#transformed lables to save path
kitti_label_tosave_path = root_dir + 'data/kitti/object/training/label_coco_format/'
