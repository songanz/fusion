...
for epoch in range(opt.epochs):
    losses_x = losses_y = losses_w = losses_h = losses_conf = \
    ...
    for label in range(num_classes):
        ...
        # for i in tqdm.tqdm(range(len(all_annotations)), desc=f"Computing AP for class '{label}'"):  # for python3.6
    ...
    for c, ap in average_precisions.items():
        # print(f"+ Class '{c}' - AP: {ap}")  # for python3.6
