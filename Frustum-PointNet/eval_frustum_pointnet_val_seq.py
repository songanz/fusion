...
network = FrustumPointNet("Frustum-PointNet_eval_val_seq", project_dir=root_dir)
network.load_state_dict(torch.load(root_dir + "pretrained_models/model_37_2_epoch_400.pth"))
network = network.cuda()

NH = network.BboxNet_network.NH

val_dataset = EvalSequenceDatasetFrustumPointNet(kitti_data_path=root_dir + "data/kitti",
