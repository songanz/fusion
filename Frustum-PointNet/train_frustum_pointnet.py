...
network = FrustumPointNet(model_id, project_dir=root_dir)
network = network.cuda()

NH = network.BboxNet_network.NH

train_dataset = DatasetFrustumPointNetAugmentation(kitti_data_path=root_dir + "data/kitti",
                                                   kitti_meta_path=root_dir + "data/kitti/meta",
                                                   type="train", NH=NH)
val_dataset = EvalDatasetFrustumPointNet(kitti_data_path=root_dir + "data/kitti",
                                         kitti_meta_path=root_dir + "data/kitti/meta",
                                         type="val", NH=NH)
