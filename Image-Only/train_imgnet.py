...
network = ImgNet(model_id, project_dir=root_dir)
network = network.cuda()

train_dataset = DatasetImgNetAugmentation(kitti_data_path=root_dir + "data/kitti",
                                          kitti_meta_path=root_dir + "data/kitti/meta",
                                          type="train")
val_dataset = DatasetImgNetEval(kitti_data_path=root_dir + "data/kitti",
                                kitti_meta_path=root_dir + "data/kitti/meta",
                                type="val")
